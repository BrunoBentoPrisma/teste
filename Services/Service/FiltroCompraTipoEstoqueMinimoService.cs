...
{
    public class FiltroCompraTipoEstoqueMinimoService : IFiltroCompraTipoEstoqueMinimoService
    {
        ...
        public FiltroCompraTipoEstoqueMinimoService(IProdutoRepository produtoRepository,
        ...
        public async Task<List<ItensCompraFiltroViewDto>> GetFiltroItensCompra(FiltroCompraDto filtroCompraDto)
        {
            try
            {
                ...
                foreach (var produto in produtos)
                {
                    ...
                    if (itemCompraViewDto.EstoqueMinimo < itemCompraViewDto.Estoque)
                    {
                        itemCompraViewDto.Quantidade = itemCompraViewDto.Estoque - itemCompraViewDto.EstoqueMinimo;
